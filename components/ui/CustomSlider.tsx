...
function CustomSlider({ slides, interval = 5000, locale }: CustomSliderProps) {
  ...
  return (
    ...
    >
      ...
      <Stack
        sx={{
          minWidth: { xs: "85vw", sm: "80vw", md: IMAGE_WIDTH },
          maxWidth: { xs: "90vw", sm: "80vw", md: IMAGE_WIDTH },
          aspectRatio: { xs: "1 / 1.05", md: "1 / 1.15" },
          // borderRadius: "10px",
      ...
      <Stack
        sx={{
          maxWidth: { xs: "80vw", md: IMAGE_WIDTH },
          flex: 1,
          alignItems: "center",
          justifyContent: "flex-end",
          pt: { xs: 2, md: 0 },
          ...
          {slides.map((slide, i) => (
            <Box
              ...
              sx={{
                ...
                borderRadius: "50%",
                border:
                  i === current ? "2.5px solid #b88e2f" : "2px solid #cacaca",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                cursor: "pointer",
